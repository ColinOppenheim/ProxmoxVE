...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/ColinOppenheim/ProxmoxVE/refs/heads/Deployment-Testing/misc/copy-data/home-assistant-core-copy-data-home-assistant-container.sh)"
